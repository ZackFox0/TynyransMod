...
namespace TynyransMod.NPCs
{
  // [AutoloadHead] and npc.townNPC are extremely important and absolutely both necessary for any Town NPC to work at all.
  [AutoloadHead]
  public class Tynyran : ModNPC
  {
    ...
    {
      shop.item[nextSlot].SetDefaults(ItemType<BloodRing>());
      shop.item[nextSlot].shopCustomPrice = 1;
      shop.item[nextSlot].shopSpecialCurrency = TynyransMod.TynCoinID;
      nextSlot++;
      shop.item[nextSlot].SetDefaults(ItemType<MicitEarrings1>());
      shop.item[nextSlot].shopCustomPrice = 2;
      shop.item[nextSlot].shopSpecialCurrency = TynyransMod.TynCoinID;
      nextSlot++;
      shop.item[nextSlot].SetDefaults(ItemType<MicitEarrings2>());
      shop.item[nextSlot].shopCustomPrice = 2;
      shop.item[nextSlot].shopSpecialCurrency = TynyransMod.TynCoinID;
    }
    ...
    {
      projType = ProjectileType<SplittingSpark>();
      attackDelay = 1;
    }
